...
class RayPPOTrainer:
    ...
    def _validate(self):
        ...
        for test_data in self.val_dataloader:
            ...
            # Filter out negative placeholder tokens (e.g. -1 for audio) before decoding
            input_texts = [self.tokenizer.decode(ids[ids >= 0], skip_special_tokens=True) for ids in input_ids]
