...
# bash submit_job.sh h-n2-wus2 dapo_ls_bias_bs64_rep_2k_gt_t12_tis5

# bash submit_job.sh h-n1-uks7 dapo_rare_fy32q2_bs64_rep  true
...
# bash submit_job.sh l-n1-uks7 grpo_ls_bias_bs64_rep_2k_gt_t12_b16 true
# bash submit_job.sh l-n1-uks7 grpo_ls_bias_bs64_rep_2k_gt_t12_tis5_n16_b16
