...
# bash submit_job.sh h-n1-uks7 recipe/phimm/config/dapo_ls_bias_bs64_rep_2k.yaml & # background job
# bash submit_job.sh l-n1-uks7 recipe/phimm/config/dapo_ls_bs64_2k.yaml & # background job
